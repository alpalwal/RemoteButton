...
ESP8266WebServer server(5646);    // Create a webserver object that listens for HTTP requests.
...
void setup(void){
  ...
  wifiMulti.addAP("yourSSID", "yourPassword");   // add Wi-Fi networks you want to connect to
